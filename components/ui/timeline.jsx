...
export const Timeline = ({
  ...
  return (
    <div
      className="w-full antialiased bg-white dark:bg-black font-sans md:px-10"
      ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-6 lg:px-0">
        ...
        <p className="mt-4 max-w-[90%] md:max-w-2xl text-[12px] md:text-base font-normal text-neutral-300 opacity-[0.9]">
