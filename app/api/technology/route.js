export async function GET() {
    return Response.json({
        hero: {
            title: "Advanced Autonomous<br />Space Systems",
            description: "NovaSpace develops high-performance propulsion, satellite intelligence, and robotic orbital platforms designed to operate reliably in complex space environments.",
            ctaButton: "Explore Missions",
            ctaLink: "/missions"
        },
        coreTechnologies: {
        ...
        cta: {
            title: "Let’s Engineer the Next Orbital Breakthrough",
            description: "Work with our engineers to design and deploy advanced systems for modern orbital operations.",
            button: "Get Started",
            ctaLink: "/contact"
        }
    },);
