    ...
    return (
        <div className="relative flex h-[30rem] md:h-[40rem] w-full overflow-hidden  bg-black antialiased md:items-center md:justify-center">
            ...
            <div className="relative z-10 mx-auto w-full max-w-7xl p-4 pt-20 md:pt-20 flex flex-col items-center gap-2 justify-center">
                <h1
                    className="bg-opacity-50 bg-gradient-to-b from-neutral-50 to-neutral-400 bg-clip-text text-center text-4xl font-bold text-transparent md:text-6xl lg:text-7xl leading-[1.1]"
                ...
                <div className="mt-6">
                    ...
                    >
                        <Link href={data?.ctaLink}>{data?.ctaButton}</Link>
                    </HoverBorderGradient>
                </div>
            </div>
        </div>
