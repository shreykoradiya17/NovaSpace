            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl mx-auto">
                    ...
                    <ul className="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 pb-8 mb-10 border-b border-white/10">
                        ...
                        <li><a href="#" className=" text-white/60 hover:text-white transition-colors duration-250">Research</a></li>
                        <li><a href="#" className=" text-white/60 hover:text-white transition-colors duration-250">About</a></li>
                        <li><a href="#" className=" text-white/60 hover:text-white transition-colors duration-250">Contact</a></li>
                    </ul>
                    <div className="flex space-x-10 justify-center items-center mb-14">
                        <a href="#" className="block  text-white/60 transition-all duration-500 hover:text-white ">
                    ...
                    <span className="text-lg text-white/30 text-center block">Designed & Developed by Shrey Koradiya</span>
                </div>
            </div>
        </footer>
    )
